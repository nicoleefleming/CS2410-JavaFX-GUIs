...
public class Hangman extends Application {
    ...
    private int APP_W = 900;
    private int APP_H = 500;
    ...
    public Parent createContent() {
        ...
        Button btSubmit = new Button("Submit Guess");
        btSubmit.setOnAction(event -> checkText());
        // layout
        HBox row1 = new HBox();
        HBox row3 = new HBox();
        ...
        Label label1 = new Label("Letter Guesses:");
        HBox hb = new HBox();
        hb.getChildren().addAll(label1, textField, btSubmit);
        hb.setSpacing(10);
    ...
    public void checkText()
    {
        ...
        char pressed = textField.getText().toUpperCase().charAt(0);
...
// This method is broken. I have no idea how to fix this.
    private String getRandomPhrase(String[] phrase)
    {
        String randomPhrase;
        int idx = new Random().nextInt(phrase.length);
        randomPhrase = (phrase[idx]);
    ...
    private void startGame() {
        File file = new File("C:\\Users\\Nicole\\IdeaProjects\\cs2410hw5.1\\src\\phrases.txt");
        ...
        word = input(file);
        String random = getRandomPhrase(word);
        hangman.reset();
        lettersToGuess.set(random.length());
    ...
    private static class HangmanImage extends Parent {
        ...
        public HangmanImage() {
            ...
            head.setCenterX(25.0);
            head.setCenterY(100.0);
            ...
            getChildren().addAll(polyline1, head, spine, leftArm, rightArm, leftLeg, rightLeg);
